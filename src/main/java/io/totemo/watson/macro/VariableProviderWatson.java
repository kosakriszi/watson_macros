    ...
    public void updateVariables(boolean clock) {
        try {
            if (Configuration.instance.isEnabled()) {
                ...
                String action = (creation == null) ? "" : (creation.booleanValue() ? "created" : "destroyed");
                ...
                if (x == null || y == null || z == null) {
                    ...
                    updateVariable("WATSON_XYZ", String.format(Locale.US, "%d, %d, %d", x, y, z));
                }
            ...
            Log.exception(Level.WARNING, "exception updating WATSON_... macro variables", ex);
        }
    }
